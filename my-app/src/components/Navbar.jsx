...
const Navbar = () => {
  ...
  <div className='searchBox border-2 p-2 rounded-xl'>
    ...
    <span>
    <input type="text" onChange={(e)=>setSearchBox(e.target.value)} className="border-none bg-transparent outline-none text-lg font-semibold" placeholder="Search Here"/>
